...
const Home = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get('https://quizzierascal-quizapp-be.onrender.com/api/leaderboard', { headers: headers });
      setLeaderboard({
        ...leaderboard,
        loading: false,
  ...
  const logout = async () => {
    ...
    await axios.delete(`https://quizzierascal-quizapp-be.onrender.com/logout/${localStorage.getItem('USER_ID')}`, {
      headers: headers,
    });
